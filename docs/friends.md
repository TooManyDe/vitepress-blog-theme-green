...
const friendLinks = ref([
  {
    ...
    desc: '每一段旅行都有终点',
    url: 'https://ddbx.org',
    avatar: 'https://vitepress-blog-theme-green.pages.dev/18.gif'
  },
  {
    name: '的的不休',
    desc: '每一段旅行都有终点',
    url: 'https://ddbx.org',
    avatar: 'https://vitepress-blog-theme-green.pages.dev/16.gif'
  },
  {
    name: '的的不休',
    desc: '每一段旅行都有终点',
    url: 'https://ddbx.org',
    avatar: 'https://vitepress-blog-theme-green.pages.dev/17.gif'
  }
])
